...
const MainSection = () => {
  return (
    <div className="w-full flex flex-col relative items-center justify-center bg-cover bg-center min-h-[90vh] md:min-h-[80vh] h-full"
         style={{
           backgroundImage: "url(/appliances.png)",
      ...
      <div className="flex flex-col items-center justify-center w-full gap-5 h-full min-h-[90vh] md:min-h-[80vh] px-5 py-10 bg-black/70">
        <div className="flex flex-col gap-5 max-w-7xl w-full">
          ...
          <p className="text-white text-lg font-light">
            ...
            a wide range of services for home appliances.
          </p>
          <CallButtons />
        </div>
      </div>
